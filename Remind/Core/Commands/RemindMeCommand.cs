...
{
    public class RemindMeCommand : IChatCommand
    {
        public const string CMD = "remindme";
        public string Name => CMD;
        public string ShortName => "rm";
        public string Description => $"Show a local notification after a delay or at a time. Usage: /{CMD} [in hh:mm:ss | at HH:mm] [message]";
